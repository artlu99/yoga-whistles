...
import type { ExternalData } from "../src/types";
...
describe("writeData mutation logic", () => {
	it("happy path", async () => {
		...
		expect(dataToStore.saltedHashedFid).toEqual(
			"64bde76b7a6c3fd19f44e243a2e00147f963876319a4126cd89c6b7473f5b457",
		);
		expect(dataToStore.shiftedTimestamp).toEqual("1679481100000");
		expect(dataToStore.obscuredMessageHash).toEqual(
			"1155d719e6ddf13561d70eaeaed3af1c453978917021e47631523a585e210fbe",
		);
